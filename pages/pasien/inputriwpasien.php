    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                ...
                ?>
                <!-- form start -->
                <form enctype="multipart/form-data" action="../control/insert.php?mode=2" method="post">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Riwayat/Keluhan Sebelumnya</label>
                            <input type="hidden" class="form-control" id="idpas" name="idpas"
                                value="<?php echo $idpas; ?>">
                            <textarea class="form-control" rows="3" id="riwayat" name="riwayat"
                                placeholder="Masukkan Riwayat/Keluhan Sebelumnya ..."></textarea>
                        </div>
                        <div class="form-group">
