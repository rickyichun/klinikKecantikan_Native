    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-2">
                        <a href="inputpasien.php?jns=lgsng"><button class="btn btn-primary"><i class="fa fa-user"></i>
                                Tambah
                                Pasien</button></a>
                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $no;?></td>
                                <td><a
                                        href="detailpasien.php?idpasien=<?php echo $data['id']; ?>"><?php echo $data['nama']; ?></a>
                                </td>
                                ...
                                <td><a href="editpasien.php?idp=<?php echo $data['id']; ?>"><button
