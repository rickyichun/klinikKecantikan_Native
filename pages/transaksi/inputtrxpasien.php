        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Transaksi/ Tindakan Pasien Terjadwal</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="../control/insert.php?mode=7" method="post">
                    <div class="card-body">
                        <?php
                            $idpas = $_GET['idpas'];
                            $querypas = mysqli_query($conn, "SELECT * FROM pasien WHERE id='$idpas'");
                            $datapas  = mysqli_fetch_array($querypas);
                            $idjdwl = $_GET['idjdwl'];
                        ?>
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" id="tgltrx"
                                name="tgltrx" placeholder="Tanggal Transaksi">
                            <input type="hidden" class="form-control" value="<?php echo $idjdwl; ?>" id="idjdwl"
                                name="idjdwl">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="pasien" name="pasien"
                                value="<?php echo $idpas; ?>">
                            <input type="nama" class="form-control" value="<?php echo $datapas['nama']; ?>" readonly>
                        </div>
