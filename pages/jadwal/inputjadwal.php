        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Jadwal Pasien Baru</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <div class="card-body">
                    <a href="inputjadwalpasien.php">
                        <button class="btn btn-sm btn-warning"><i class="fa fa-user"> </i> Pasien Lama</button>
                    </a>
                </div>
                <form enctype="multipart/form-data" action="../control/insert.php?mode=9" method="post">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama pasien Baru"
                                required>
                            <input type="hidden" class="form-control" id="idpas" name="idpas" value="0">
                        </div>
                        <div class="form-group">
